...
在前文的文章中，我们讲到了 [React 数据流](/blog/react/data-flow-management-in--react) 相关的知识。在本文中将介绍 redux 的实现原理。

在本文开始之前，有一些内容需要忘记：

- redux 和 react 是没有关系的，它可以被用在任何框架中
- connect 不属于 redux，它属于 react-redux，可以看[该片文章](/blog/react/redux-more#react-redux)有过介绍
- redux 就是一个状态管理器
